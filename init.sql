...
INSERT INTO faq
VALUES
	(1, '동영상 시청은 어떻게 하나요?', 'A 화면 어딘가에 박혀있는 B라는 버튼을 누르면 어디로 navigation 되는데 ~~~', '98a12345-ad7e-11ef-8e5c-0242ac140002', '98a10847-ad7e-11ef-8e5c-0242ac140002', NULL, NOW());
...
VALUES
(1, '98a12345-ad7e-11ef-8e5c-0242ac140002', '수업 커리큘럼 내 과제는 어떻게 진행되는 건가요?', '안녕하세요. 이번 클래스에 참가하고 싶은 학생입니다. 수업 내에 과제 관련된 내용이 포함되어 있던데, 이것에 대한 자세한 운영 계획을 들어볼 수 있을까요?', 'PRIVATE', NOW(), NULL, 'c99fd58f-b0ae-11ef-89d8-0242ac140003');
